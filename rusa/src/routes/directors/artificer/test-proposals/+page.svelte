<!--
  /directors/artificer/test-proposals — TheArtificer: Test Proposal Review Queue
  Approve/reject new test methods proposed by Physicists.
-->
<script lang="ts">
...
<p class="hint">Approve or reject new test methods proposed by Physicists.</p>
