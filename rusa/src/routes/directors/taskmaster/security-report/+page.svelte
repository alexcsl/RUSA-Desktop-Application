<!--
  Taskmaster Security Report — submit incident report to GalacticSecurityHead.
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents observed in your operational domain.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Command Bay, Sector 4" required />
    </div>
