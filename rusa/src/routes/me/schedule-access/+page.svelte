<!--
  /me/schedule-access — Control which psychiatrist assistants can view your schedule.
...
<div class="page">
  ...
  <p class="sub">Control which psychiatrist assistants can view and book appointments on your behalf.</p>
  ...
  {:else if settings.length === 0}
    <div class="empty-state">
      ...
      <p class="muted small">When a psychiatrist assistant requests access to your schedule, it will appear here.</p>
    </div>
  {:else}
    <div class="list">
      {#each settings as s}
...
<style>
  ...
  .empty-state { text-align:center;padding:2rem;background:#111827;border-radius:8px;border:1px solid rgba(58,190,255,0.08);display:flex;flex-direction:column;gap:0.4rem; }
