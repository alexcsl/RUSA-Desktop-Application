<!--
  Artificer Security Report — submit incident report to GalacticSecurityHead.
  Access: TheArtificer
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents observed in your scientific domain.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Engineering Lab 3, Sector 7" required />
    </div>
