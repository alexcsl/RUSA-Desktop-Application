<!--
  Nomad Security Report — submit incident report to GalacticSecurityHead.
  Access: TheNomad
-->
<script lang="ts">
  ...
  <form onsubmit={handleSubmit} class="report-form">
    <div class="field">
      ...
      <select id="incident_type" bind:value={form.incident_type} required>
        ...
        <option value="unauthorized_relocation">Unauthorized Relocation</option>
        <option value="civil_unrest">Civil Unrest</option>
        <option value="settler_threat">Settler Threat</option>
        <option value="settlement_breach">Settlement Breach</option>
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Settlement Alpha, Sector 3" required />
    </div>
