<!--
  /scientists/tasks — UC-GS-01: Scientist Task Inbox
  Displays tasks assigned by Artificer/Observer to the current scientist.
-->
<script lang="ts">
  import { onMount } from 'svelte';
  import { getMyTasks, type ScientistTask } from '$lib/stores/scientists';
  ...
  <table class="tbl">
    ...
    <tbody>
      {#each tasks as t}
        <tr>
          <td>
            <a href="/scientists/tasks/{t.id}">{t.title}</a>
          </td>
