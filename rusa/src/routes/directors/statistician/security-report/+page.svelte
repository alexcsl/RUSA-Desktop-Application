<!--
  Statistician Security Report — submit incident report to GalacticSecurityHead.
  Access: TheStatistician
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents related to data operations or analyst activities.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Data Center, Analysis Lab" required />
    </div>
