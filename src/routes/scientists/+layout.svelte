<!--
  Scientists area layout — shared sidebar for all /scientists/* routes.
  Provides navigation contextual to the logged-in scientist role.
...
<script lang="ts">
  ...
  function formatNotifType(type_: string): string {
    const map: Record<string, string> = {
      ...
      'math_results:submitted': 'Math Results',
      'test_proposal:outcome': 'Test Proposal',
      'final_doc:submitted': 'Final Document',
