<!--
  Wanderer Security Report — submit incident report to GalacticSecurityHead.
  Access: TheWanderer
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents observed during mission operations.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Mission Site Alpha, Sector 12" required />
    </div>
