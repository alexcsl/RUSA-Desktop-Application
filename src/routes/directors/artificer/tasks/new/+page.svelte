<!-- /directors/artificer/tasks/new — TheArtificer (UC-ART-01/02/03/04)
...
<script lang="ts">
  ...
  const validRoles = ['Mathematician', 'Physicist'];
...
<h1 class="title">Artificer — Task Management</h1>
<p class="subtitle">Assign tasks, review incoming help requests, and gate outbound responses for Math & Physics.</p>
...
<!-- UC-ART-03: Incoming cross-department help request proxy review -->
...
{:else}
<!-- UC-ART-04: Outgoing help response proxy review -->
<div class="review-section">
