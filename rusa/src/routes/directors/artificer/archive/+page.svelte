<!--
  Artificer: Science Archive view — physical objects/phenomena.
  Access: TheArtificer
-->
<script lang="ts">
...
<h2 class="title">Objects and Phenomena Archive</h2>
<p class="subtitle">Approved physical objects and phenomena submitted by your domain's personnel.</p>
