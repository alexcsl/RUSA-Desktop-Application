<!--
  Observer Security Report — submit incident report to GalacticSecurityHead.
  Access: TheObserver
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents observed in your biological and chemical research domain.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Biology Lab 2, Greenhouse Module" required />
    </div>
