<!--
  /directors/guardian/tasks — Security Team Task Overview
  TheGuardian views all tasks assigned to security personnel.
-->
<script lang="ts">
...
<h1 class="title">Security Team Tasks</h1>
<p class="subtitle">Tasks assigned to security personnel under your command.</p>
