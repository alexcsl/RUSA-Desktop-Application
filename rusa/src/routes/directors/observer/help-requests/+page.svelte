<!--
  /directors/observer/help-requests — Review Help Requests (UC-OBS-03/04)
  TheObserver reviews incoming help requests from scientists and data analysts.
-->
<script lang="ts">
  import { onMount } from 'svelte';
  import { invoke } from '@tauri-apps/api/core';
  import { reviewHelpResponse } from '$lib/stores/directors';
  ...
  onMount(async () => { await loadRequests(); });
...
<p class="subtitle">Incoming help requests from your division requiring review.</p>
