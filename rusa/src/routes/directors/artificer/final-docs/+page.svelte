<!--
  /directors/artificer/final-docs — TheArtificer: Final Document Review Queue
  Approve/reject final object documents (matter / physical_object) → science_archive.
-->
<script lang="ts">
...
<p class="hint">Review final object documents (matter & physical objects) for archiving.</p>
