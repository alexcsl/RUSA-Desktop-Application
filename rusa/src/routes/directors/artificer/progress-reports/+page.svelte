<!--
  Artificer: Task Progress Reports
  Shows progress_reports (from engineers) and task payload progress updates
  (from Mathematician, Physicist, AerospaceEngineer).
  Access: TheArtificer
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Progress updates from Mathematician, Physicist, and AerospaceEngineer.</p>
