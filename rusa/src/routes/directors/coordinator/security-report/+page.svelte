<!--
  Coordinator Security Report — submit incident report to GalacticSecurityHead.
  Access: TheCoordinator
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Report security incidents related to coordinated events or external parties.</p>
  ...
  <form onsubmit={handleSubmit} class="report-form">
    <div class="field">
      ...
      <select id="incident_type" bind:value={form.incident_type} required>
        ...
        <option value="hazardous_condition">Hazardous Condition</option>
        <option value="equipment_tampering">Equipment Tampering</option>
    ...
    <div class="field">
      ...
      <input id="location" type="text" bind:value={form.location} placeholder="e.g. Event Hall B, External Dock" required />
    </div>
