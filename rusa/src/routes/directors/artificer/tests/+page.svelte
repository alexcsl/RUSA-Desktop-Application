<!--
  Artificer: Approved Tests view — shows tests approved for Physicist / Mathematician / AerospaceEngineer.
  Access: TheArtificer
-->
<script lang="ts">
...
<p class="subtitle">Tests approved for your domain's personnel.</p>
