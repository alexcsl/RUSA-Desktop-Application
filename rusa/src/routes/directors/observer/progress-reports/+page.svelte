<!--
  Observer: Task Progress Reports
  Shows progress_reports (from AgriculturalEngineer, BiologicalEngineer) and
  task payload progress updates (from Biologist, Chemist).
  Access: TheObserver
-->
<script lang="ts">
...
<div class="page">
  ...
  <p class="subtitle">Progress updates from Biologist, Chemist, AgriculturalEngineer, and BiologicalEngineer.</p>
